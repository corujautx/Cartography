...
private func reduce(elements: [LayoutProxy], combine: (LayoutProxy, LayoutProxy) -> NSLayoutConstraint) -> [NSLayoutConstraint] {
...
///
public func distribute(by amount: CGFloat = 0.0, horizontally views: [LayoutProxy]) -> [NSLayoutConstraint] {
...
/// - returns: An array of `NSLayoutConstraint` instances.
///
public func distribute(by amount: CGFloat = 0.0, leftToRight views: [LayoutProxy]) -> [NSLayoutConstraint] {
...
/// - returns: An array of `NSLayoutConstraint` instances.
///
public func distribute(by amount: CGFloat = 0.0, vertically views: [LayoutProxy]) -> [NSLayoutConstraint] {
...
/// - returns: An array of `NSLayoutConstraint` instances.
///
public func distribute(by amount: CGFloat = 0.0, horizontally first: LayoutProxy, _ rest: LayoutProxy...) -> [NSLayoutConstraint] {
...
/// - returns: An array of `NSLayoutConstraint` instances.
///
public func distribute(by amount: CGFloat = 0.0, leftToRight first: LayoutProxy, _ rest: LayoutProxy...) -> [NSLayoutConstraint] {
